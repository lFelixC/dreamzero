...
class WANPolicyHeadConfig(PretrainedConfig):
    ...
    mot_decouple_video_action_noise: bool = field(
        default=False,
        metadata={"help": "MoT full-video training: video uses the fixed one-step inference initial timestep (or Beta distribution when mot_video_noise_beta_* are set), action uses independent uniform timesteps."},
    )
