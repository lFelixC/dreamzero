...
ALOHA_DATA_ROOT="/data/datasets/dreamzero/1k_demo_lerobot_merged_v4_shuffled"
...
OUTPUT_DIR="${CHECKPOINT_ROOT}/dreamzero_aloha_x5lite_bimanual_full_finetune_shuffled"
