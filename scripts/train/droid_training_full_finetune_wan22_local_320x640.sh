...
TRAIN_OVERRIDES=(
    ...
    "image_resolution_width=320"                                                # 每路相机宽度保持 320
    "image_resolution_height=160"                                               # 每路相机高度保持 160；拼图后自然得到 320x640
    "frame_seqlen=${MODEL_FRAME_SEQLEN}"                                        # 320x640 composite 在 Wan2.2 VAE38 + patch(2x2) 下对应 200 token/frame
