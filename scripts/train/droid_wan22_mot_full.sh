...
MOT_DECOUPLED_TRAINING_ACTION_STEPS="${MOT_DECOUPLED_TRAINING_ACTION_STEPS:-null}"
...
echo "Using MOT_DECOUPLED_TRAINING_ACTION_STEPS=${MOT_DECOUPLED_TRAINING_ACTION_STEPS}"
...
"${LAUNCH_CMD[@]}" \
  ...
  mot_decoupled_training_action_steps="${MOT_DECOUPLED_TRAINING_ACTION_STEPS}" \
