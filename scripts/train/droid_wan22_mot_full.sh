...
MODEL_TARGET_HEIGHT="${MODEL_TARGET_HEIGHT:-${TARGET_VIDEO_HEIGHT:-320}}"
MODEL_TARGET_WIDTH="${MODEL_TARGET_WIDTH:-${TARGET_VIDEO_WIDTH:-640}}"
MODEL_FRAME_SEQLEN="${MODEL_FRAME_SEQLEN:-${FRAME_SEQLEN:-200}}"
...
echo "Using LEARNING_RATE=${LEARNING_RATE}"
