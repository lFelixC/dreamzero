...
DATALOADER_WARMUP_BATCHES="${DATALOADER_WARMUP_BATCHES:-20}"
SHARD_PREFETCH_DELAY_SAMPLES="${SHARD_PREFETCH_DELAY_SAMPLES:-512}"
TRAIN_STEP_BARRIER="${TRAIN_STEP_BARRIER:-true}"
TRAIN_STEP_BARRIER_STEPS="${TRAIN_STEP_BARRIER_STEPS:-20}"
