...
ROBOTWIN_DATA_ROOT="${ROBOTWIN_DATA_ROOT:-${DATASET_ROOT}/robotwin_unified_dreamzero_180x320}"
...
OUTPUT_DIR="${OUTPUT_DIR:-${CHECKPOINT_ROOT}/robotwin_pretrain_wan22_${ARCH}}"
