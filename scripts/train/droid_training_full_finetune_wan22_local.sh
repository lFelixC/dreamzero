...
# Compatibility entry for the old local DROID Wan2.2 script.
# Prefer the canonical script for new 320x640 / frame_seqlen=200 runs.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${CHECKPOINT_ROOT}/dreamzero_droid_wan22_full_finetune}"
