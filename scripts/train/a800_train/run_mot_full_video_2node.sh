...
# A800 2-node MoT experiment: action expert sees full video K/V.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${CHECKPOINT_ROOT}/dreamzero_droid_wan22_mot_a800_full_video_2node}"
