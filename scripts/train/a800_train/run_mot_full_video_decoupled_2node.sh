...
# A800 multi-node MoT experiment: full-video attention with decoupled video/action noise.
...
OUTPUT_DIR="${OUTPUT_DIR:-${CHECKPOINT_ROOT}/dreamzero_droid_wan22_mot_a800_full_video_decoupled_2node}"
...
echo "========== decoupled full-video MoT multi-node launch config =========="
