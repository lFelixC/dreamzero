...
# AI Station/OpenMPI wrapper for the A800 decoupled full-video MoT experiment.
# Submit this script as the MPI job script. It keeps the experiment settings in
# run_mot_full_video_decoupled_2node.sh and only maps MPI topology to torchrun
# topology.
...
exec bash "${SCRIPT_DIR}/run_mot_full_video_decoupled_2node.sh" "$@"
